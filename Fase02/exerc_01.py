...
# RedPill um laço de repetição deve retirar 1 vida ,a cada iteração, para o total de letras de seu nome. 
    if pergunta_final == '1':
...
# BluePill um laço de repetição deve retirar 1 vida por iteração até que seu score seja menor ou igual a zero. 
    if pergunta_final == '2':
